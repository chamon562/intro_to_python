...
channee_checking.withdraw(1500, 1555)
# print("My current balance is ${}.".format(channee_checking.balance))

channee_checking.withdraw(2000, 1234)
# print("My overdraft fee is currently {}".format(channee_checking.overdraft_fees))
# print("My current balance is ${}.".format(channee_checking.balance))

channee_checking.change_pin(9987)

# think of class you would like to make 
# think of 3 methods  
